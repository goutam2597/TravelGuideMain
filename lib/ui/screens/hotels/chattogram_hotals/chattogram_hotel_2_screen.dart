...
class ChattogramHotel2Screen extends StatefulWidget {

  const ChattogramHotel2Screen({super.key});

  @override
  State<ChattogramHotel2Screen> createState() => _ChattogramHotel2ScreenState();
}

class _ChattogramHotel2ScreenState extends State<ChattogramHotel2Screen> {
