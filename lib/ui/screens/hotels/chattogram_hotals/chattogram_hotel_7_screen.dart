...
class ChattogramHotel7Screen extends StatefulWidget {

  const ChattogramHotel7Screen({super.key});

  @override
  State<ChattogramHotel7Screen> createState() => _ChattogramHotel7ScreenState();
}

class _ChattogramHotel7ScreenState extends State<ChattogramHotel7Screen> {
