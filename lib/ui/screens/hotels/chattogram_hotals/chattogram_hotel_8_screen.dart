...
class ChattogramHotel8Screen extends StatefulWidget {

  const ChattogramHotel8Screen({super.key});

  @override
  State<ChattogramHotel8Screen> createState() => _ChattogramHotel8ScreenState();
}

class _ChattogramHotel8ScreenState extends State<ChattogramHotel8Screen> {
