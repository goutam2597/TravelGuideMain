...
class ChattogramHotel1Screen extends StatefulWidget {

  const ChattogramHotel1Screen({super.key});

  @override
  State<ChattogramHotel1Screen> createState() => _ChattogramHotel1ScreenState();
}

class _ChattogramHotel1ScreenState extends State<ChattogramHotel1Screen> {
