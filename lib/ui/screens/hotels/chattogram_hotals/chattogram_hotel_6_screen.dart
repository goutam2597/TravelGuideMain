...
class ChattogramHotel6Screen extends StatefulWidget {

  const ChattogramHotel6Screen({super.key});

  @override
  State<ChattogramHotel6Screen> createState() => _ChattogramHotel6ScreenState();
}

class _ChattogramHotel6ScreenState extends State<ChattogramHotel6Screen> {
