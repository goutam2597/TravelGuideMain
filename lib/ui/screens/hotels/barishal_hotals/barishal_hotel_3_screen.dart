...
class BarishalHotel3Screen extends StatefulWidget {

  const BarishalHotel3Screen({super.key});

  @override
  State<BarishalHotel3Screen> createState() => _BarishalHotel3ScreenState();
}

class _BarishalHotel3ScreenState extends State<BarishalHotel3Screen> {
