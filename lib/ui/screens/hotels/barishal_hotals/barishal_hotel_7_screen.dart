...
class BarishalHotel7Screen extends StatefulWidget {

  const BarishalHotel7Screen({super.key});

  @override
  State<BarishalHotel7Screen> createState() => _BarishalHotel7ScreenState();
}

class _BarishalHotel7ScreenState extends State<BarishalHotel7Screen> {
