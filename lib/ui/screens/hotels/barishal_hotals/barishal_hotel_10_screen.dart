...
class BarishalHotel10Screen extends StatefulWidget {

  const BarishalHotel10Screen({super.key});

  @override
  State<BarishalHotel10Screen> createState() => _BarishalHotel10ScreenState();
}

class _BarishalHotel10ScreenState extends State<BarishalHotel10Screen> {
