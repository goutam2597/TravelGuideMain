...
class BarishalHotel2Screen extends StatefulWidget {

  const BarishalHotel2Screen({super.key});

  @override
  State<BarishalHotel2Screen> createState() => _BarishalHotel2ScreenState();
}

class _BarishalHotel2ScreenState extends State<BarishalHotel2Screen> {
