...
class BarishalHotel4Screen extends StatefulWidget {

  const BarishalHotel4Screen({super.key});

  @override
  State<BarishalHotel4Screen> createState() => _BarishalHotel4ScreenState();
}

class _BarishalHotel4ScreenState extends State<BarishalHotel4Screen> {
