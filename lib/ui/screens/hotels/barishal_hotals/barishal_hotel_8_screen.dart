...
class BarishalHotel8Screen extends StatefulWidget {

  const BarishalHotel8Screen({super.key});

  @override
  State<BarishalHotel8Screen> createState() => _BarishalHotel8ScreenState();
}

class _BarishalHotel8ScreenState extends State<BarishalHotel8Screen> {
