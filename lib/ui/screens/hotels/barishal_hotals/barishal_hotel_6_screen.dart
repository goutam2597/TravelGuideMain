...
class BarishalHotel6Screen extends StatefulWidget {

  const BarishalHotel6Screen({super.key});

  @override
  State<BarishalHotel6Screen> createState() => _BarishalHotel6ScreenState();
}

class _BarishalHotel6ScreenState extends State<BarishalHotel6Screen> {
