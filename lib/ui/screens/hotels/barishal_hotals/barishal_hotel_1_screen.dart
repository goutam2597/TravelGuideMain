...
class BarishalHotel1Screen extends StatefulWidget {

  const BarishalHotel1Screen({super.key});

  @override
  State<BarishalHotel1Screen> createState() => _BarishalHotel1ScreenState();
}

class _BarishalHotel1ScreenState extends State<BarishalHotel1Screen> {
