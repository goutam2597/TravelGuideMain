...
class BarishalHotel9Screen extends StatefulWidget {

  const BarishalHotel9Screen({super.key});

  @override
  State<BarishalHotel9Screen> createState() => _BarishalHotel9ScreenState();
}

class _BarishalHotel9ScreenState extends State<BarishalHotel9Screen> {
