...
class BarishalHotel5Screen extends StatefulWidget {

  const BarishalHotel5Screen({super.key});

  @override
  State<BarishalHotel5Screen> createState() => _BarishalHotel5ScreenState();
}

class _BarishalHotel5ScreenState extends State<BarishalHotel5Screen> {
