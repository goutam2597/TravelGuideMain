...
class RangpurHotel6Screen extends StatefulWidget {

  const RangpurHotel6Screen({super.key});

  @override
  State<RangpurHotel6Screen> createState() => _RangpurHotel6ScreenState();
}

class _RangpurHotel6ScreenState extends State<RangpurHotel6Screen> {
