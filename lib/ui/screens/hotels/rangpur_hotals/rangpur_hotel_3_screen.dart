...
class RangpurHotel3Screen extends StatefulWidget {

  const RangpurHotel3Screen({super.key});

  @override
  State<RangpurHotel3Screen> createState() => _RangpurHotel3ScreenState();
}

class _RangpurHotel3ScreenState extends State<RangpurHotel3Screen> {
