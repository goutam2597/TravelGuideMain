...
class RangpurHotel5Screen extends StatefulWidget {

  const RangpurHotel5Screen({super.key});

  @override
  State<RangpurHotel5Screen> createState() => _RangpurHotel5ScreenState();
}

class _RangpurHotel5ScreenState extends State<RangpurHotel5Screen> {
