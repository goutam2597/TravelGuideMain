...
class RangpurHotel7Screen extends StatefulWidget {

  const RangpurHotel7Screen({super.key});

  @override
  State<RangpurHotel7Screen> createState() => _RangpurHotel7ScreenState();
}

class _RangpurHotel7ScreenState extends State<RangpurHotel7Screen> {
