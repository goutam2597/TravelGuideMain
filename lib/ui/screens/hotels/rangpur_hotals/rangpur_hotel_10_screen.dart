...
class RangpurHotel10Screen extends StatefulWidget {

  const RangpurHotel10Screen({super.key});

  @override
  State<RangpurHotel10Screen> createState() => _RangpurHotel10ScreenState();
}

class _RangpurHotel10ScreenState extends State<RangpurHotel10Screen> {
