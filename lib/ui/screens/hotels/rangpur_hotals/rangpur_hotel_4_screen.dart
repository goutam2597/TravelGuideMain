...
class RangpurHotel4Screen extends StatefulWidget {

  const RangpurHotel4Screen({super.key});

  @override
  State<RangpurHotel4Screen> createState() => _RangpurHotel4ScreenState();
}

class _RangpurHotel4ScreenState extends State<RangpurHotel4Screen> {
