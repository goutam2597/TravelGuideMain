...
class RangpurHotel8Screen extends StatefulWidget {

  const RangpurHotel8Screen({super.key});

  @override
  State<RangpurHotel8Screen> createState() => _RangpurHotel8ScreenState();
}

class _RangpurHotel8ScreenState extends State<RangpurHotel8Screen> {
