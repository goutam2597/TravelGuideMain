...
class RangpurHotel2Screen extends StatefulWidget {

  const RangpurHotel2Screen({super.key});

  @override
  State<RangpurHotel2Screen> createState() => _RangpurHotel2ScreenState();
}

class _RangpurHotel2ScreenState extends State<RangpurHotel2Screen> {
