...
class RangpurHotel1Screen extends StatefulWidget {

  const RangpurHotel1Screen({super.key});

  @override
  State<RangpurHotel1Screen> createState() => _RangpurHotel1ScreenState();
}

class _RangpurHotel1ScreenState extends State<RangpurHotel1Screen> {
