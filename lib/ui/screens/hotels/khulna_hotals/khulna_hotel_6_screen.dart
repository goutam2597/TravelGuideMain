...
class khulnaHotel6Screen extends StatefulWidget {

  const khulnaHotel6Screen({super.key});

  @override
  State<khulnaHotel6Screen> createState() => _khulnaHotel6ScreenState();
}

class _khulnaHotel6ScreenState extends State<khulnaHotel6Screen> {
