...
class khulnaHotel3Screen extends StatefulWidget {

  const khulnaHotel3Screen({super.key});

  @override
  State<khulnaHotel3Screen> createState() => _khulnaHotel3ScreenState();
}

class _khulnaHotel3ScreenState extends State<khulnaHotel3Screen> {
