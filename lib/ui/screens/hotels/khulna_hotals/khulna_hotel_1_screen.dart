...
class khulnaHotel1Screen extends StatefulWidget {

  const khulnaHotel1Screen({super.key});

  @override
  State<khulnaHotel1Screen> createState() => _khulnaHotel1ScreenState();
}

class _khulnaHotel1ScreenState extends State<khulnaHotel1Screen> {
