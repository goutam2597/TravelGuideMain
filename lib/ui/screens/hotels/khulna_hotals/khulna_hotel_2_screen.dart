...
class khulnaHotel2Screen extends StatefulWidget {

  const khulnaHotel2Screen({super.key});

  @override
  State<khulnaHotel2Screen> createState() => _khulnaHotel2ScreenState();
}

class _khulnaHotel2ScreenState extends State<khulnaHotel2Screen> {
