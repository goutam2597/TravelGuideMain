...
class khulnaHotel7Screen extends StatefulWidget {

  const khulnaHotel7Screen({super.key});

  @override
  State<khulnaHotel7Screen> createState() => _khulnaHotel7ScreenState();
}

class _khulnaHotel7ScreenState extends State<khulnaHotel7Screen> {
