...
class khulnaHotel8Screen extends StatefulWidget {

  const khulnaHotel8Screen({super.key});

  @override
  State<khulnaHotel8Screen> createState() => _khulnaHotel8ScreenState();
}

class _khulnaHotel8ScreenState extends State<khulnaHotel8Screen> {
