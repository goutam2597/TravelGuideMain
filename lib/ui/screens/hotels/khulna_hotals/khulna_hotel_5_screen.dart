...
class khulnaHotel5Screen extends StatefulWidget {

  const khulnaHotel5Screen({super.key});

  @override
  State<khulnaHotel5Screen> createState() => _khulnaHotel5ScreenState();
}

class _khulnaHotel5ScreenState extends State<khulnaHotel5Screen> {
