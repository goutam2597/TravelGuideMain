...
class khulnaHotel9Screen extends StatefulWidget {

  const khulnaHotel9Screen({super.key});

  @override
  State<khulnaHotel9Screen> createState() => _khulnaHotel9ScreenState();
}

class _khulnaHotel9ScreenState extends State<khulnaHotel9Screen> {
