...
class khulnaHotel4Screen extends StatefulWidget {

  const khulnaHotel4Screen({super.key});

  @override
  State<khulnaHotel4Screen> createState() => _khulnaHotel4ScreenState();
}

class _khulnaHotel4ScreenState extends State<khulnaHotel4Screen> {
