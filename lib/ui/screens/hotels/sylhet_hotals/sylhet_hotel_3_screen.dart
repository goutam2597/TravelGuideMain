...
class SylhetHotel3Screen extends StatefulWidget {

  const SylhetHotel3Screen({super.key});

  @override
  State<SylhetHotel3Screen> createState() => _SylhetHotel3ScreenState();
}

class _SylhetHotel3ScreenState extends State<SylhetHotel3Screen> {
