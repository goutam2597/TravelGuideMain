...
class SylhetHotel10Screen extends StatefulWidget {

  const SylhetHotel10Screen({super.key});

  @override
  State<SylhetHotel10Screen> createState() => _SylhetHotel10ScreenState();
}

class _SylhetHotel10ScreenState extends State<SylhetHotel10Screen> {
