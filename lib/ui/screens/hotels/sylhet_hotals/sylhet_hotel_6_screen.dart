...
class SylhetHotel6Screen extends StatefulWidget {

  const SylhetHotel6Screen({super.key});

  @override
  State<SylhetHotel6Screen> createState() => _SylhetHotel6ScreenState();
}

class _SylhetHotel6ScreenState extends State<SylhetHotel6Screen> {
