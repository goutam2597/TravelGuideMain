...
class SylhetHotel4Screen extends StatefulWidget {

  const SylhetHotel4Screen({super.key});

  @override
  State<SylhetHotel4Screen> createState() => _SylhetHotel4ScreenState();
}

class _SylhetHotel4ScreenState extends State<SylhetHotel4Screen> {
