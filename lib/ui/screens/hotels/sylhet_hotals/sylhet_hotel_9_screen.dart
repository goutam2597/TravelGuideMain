...
class SylhetHotel9Screen extends StatefulWidget {

  const SylhetHotel9Screen({super.key});

  @override
  State<SylhetHotel9Screen> createState() => _SylhetHotel9ScreenState();
}

class _SylhetHotel9ScreenState extends State<SylhetHotel9Screen> {
