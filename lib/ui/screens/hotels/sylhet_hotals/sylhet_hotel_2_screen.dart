...
class SylhetHotel2Screen extends StatefulWidget {

  const SylhetHotel2Screen({super.key});

  @override
  State<SylhetHotel2Screen> createState() => _SylhetHotel2ScreenState();
}

class _SylhetHotel2ScreenState extends State<SylhetHotel2Screen> {
