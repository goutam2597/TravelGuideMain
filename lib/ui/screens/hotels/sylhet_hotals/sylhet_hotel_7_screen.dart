...
class SylhetHotel7Screen extends StatefulWidget {

  const SylhetHotel7Screen({super.key});

  @override
  State<SylhetHotel7Screen> createState() => _SylhetHotel7ScreenState();
}

class _SylhetHotel7ScreenState extends State<SylhetHotel7Screen> {
