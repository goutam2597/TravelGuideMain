...
class DhakaHotel3Screen extends StatefulWidget {

  const DhakaHotel3Screen({super.key});

  @override
  State<DhakaHotel3Screen> createState() => _DhakaHotel3ScreenState();
}

class _DhakaHotel3ScreenState extends State<DhakaHotel3Screen> {
