...
class DhakaHotel2Screen extends StatefulWidget {

  const DhakaHotel2Screen({super.key});

  @override
  State<DhakaHotel2Screen> createState() => _DhakaHotel2ScreenState();
}

class _DhakaHotel2ScreenState extends State<DhakaHotel2Screen> {
