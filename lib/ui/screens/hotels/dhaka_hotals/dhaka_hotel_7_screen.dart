...
class DhakaHotel7Screen extends StatefulWidget {

  const DhakaHotel7Screen({super.key});

  @override
  State<DhakaHotel7Screen> createState() => _DhakaHotel7ScreenState();
}

class _DhakaHotel7ScreenState extends State<DhakaHotel7Screen> {
