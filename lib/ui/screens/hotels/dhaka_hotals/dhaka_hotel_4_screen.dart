...
class DhakaHotel4Screen extends StatefulWidget {

  const DhakaHotel4Screen({super.key});

  @override
  State<DhakaHotel4Screen> createState() => _DhakaHotel4ScreenState();
}

class _DhakaHotel4ScreenState extends State<DhakaHotel4Screen> {
