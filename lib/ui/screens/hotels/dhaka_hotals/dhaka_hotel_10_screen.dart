...
class DhakaHotel10Screen extends StatefulWidget {

  const DhakaHotel10Screen({super.key});

  @override
  State<DhakaHotel10Screen> createState() => _DhakaHotel10ScreenState();
}

class _DhakaHotel10ScreenState extends State<DhakaHotel10Screen> {
