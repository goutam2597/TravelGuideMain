...
class DhakaHotel5Screen extends StatefulWidget {

  const DhakaHotel5Screen({super.key});

  @override
  State<DhakaHotel5Screen> createState() => _DhakaHotel5ScreenState();
}

class _DhakaHotel5ScreenState extends State<DhakaHotel5Screen> {
