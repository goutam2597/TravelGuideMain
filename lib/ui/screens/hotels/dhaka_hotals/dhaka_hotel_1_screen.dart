...
class DhakaHotel1Screen extends StatefulWidget {

  const DhakaHotel1Screen({super.key});

  @override
  State<DhakaHotel1Screen> createState() => _DhakaHotel1ScreenState();
}

class _DhakaHotel1ScreenState extends State<DhakaHotel1Screen> {
