...
class DhakaHotel6Screen extends StatefulWidget {

  const DhakaHotel6Screen({super.key});

  @override
  State<DhakaHotel6Screen> createState() => _DhakaHotel6ScreenState();
}

class _DhakaHotel6ScreenState extends State<DhakaHotel6Screen> {
