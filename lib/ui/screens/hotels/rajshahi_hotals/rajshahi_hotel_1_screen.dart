...
class RajshahiHotel1Screen extends StatefulWidget {

  const RajshahiHotel1Screen({super.key});

  @override
  State<RajshahiHotel1Screen> createState() => _RajshahiHotel1ScreenState();
}

class _RajshahiHotel1ScreenState extends State<RajshahiHotel1Screen> {
