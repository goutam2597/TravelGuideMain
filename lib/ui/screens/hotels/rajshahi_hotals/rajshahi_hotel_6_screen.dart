...
class RajshahiHotel6Screen extends StatefulWidget {

  const RajshahiHotel6Screen({super.key});

  @override
  State<RajshahiHotel6Screen> createState() => _RajshahiHotel6ScreenState();
}

class _RajshahiHotel6ScreenState extends State<RajshahiHotel6Screen> {
