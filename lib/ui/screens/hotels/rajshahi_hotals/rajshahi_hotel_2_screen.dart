...
class RajshahiHotel2Screen extends StatefulWidget {

  const RajshahiHotel2Screen({super.key});

  @override
  State<RajshahiHotel2Screen> createState() => _RajshahiHotel2ScreenState();
}

class _RajshahiHotel2ScreenState extends State<RajshahiHotel2Screen> {
