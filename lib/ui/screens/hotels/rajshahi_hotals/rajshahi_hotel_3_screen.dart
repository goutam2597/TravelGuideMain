...
class RajshahiHotel3Screen extends StatefulWidget {

  const RajshahiHotel3Screen({super.key});

  @override
  State<RajshahiHotel3Screen> createState() => _RajshahiHotel3ScreenState();
}

class _RajshahiHotel3ScreenState extends State<RajshahiHotel3Screen> {
