...
class RajshahiHotel4Screen extends StatefulWidget {

  const RajshahiHotel4Screen({super.key});

  @override
  State<RajshahiHotel4Screen> createState() => _RajshahiHotel4ScreenState();
}

class _RajshahiHotel4ScreenState extends State<RajshahiHotel4Screen> {
