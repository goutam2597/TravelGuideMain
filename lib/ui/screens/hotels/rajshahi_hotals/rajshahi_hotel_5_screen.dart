...
class RajshahiHotel5Screen extends StatefulWidget {

  const RajshahiHotel5Screen({super.key});

  @override
  State<RajshahiHotel5Screen> createState() => _RajshahiHotel5ScreenState();
}

class _RajshahiHotel5ScreenState extends State<RajshahiHotel5Screen> {
